...
class LogisticRegressionBatch(ClassificationBase):
    """
    Train *one* model.
    """
    def __init__(self, X, y, eta0, lam, W=None, max_iter=10**6,
        ...
        super(LogisticRegressionBatch, self).__init__(X=X, y=y, W=W)
        self.eta0 = eta0
        self.eta = eta0
        self.lam = lam
    ...
    def plot_test_and_train_log_loss_during_fitting(
        ...
        fig = super(LogisticRegressionBatch, self).plot_ys(
...
class LogisticRegressionBinaryBatch(LogisticRegressionBatch):
    """
    Train *one* model.
    """
